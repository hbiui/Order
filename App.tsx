...
const App: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto min-h-screen bg-slate-50 relative overflow-x-hidden">
      ...
      <nav className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-white/95 backdrop-blur-2xl border-t border-slate-100 safe-bottom z-40 flex justify-around items-center px-8 py-5 rounded-t-[48px] shadow-[0_-20px_50px_rgba(0,0,0,0.06)]">
        {[
